...
<head>
    ...
    <title>Mehrshad - Backend Developer</title>
    <style>
        body {
...
<body>
    <div class="container">
        ...
        <div class="section experience">
            <h2>💼 Experience</h2>
            <p><strong>DarkCode</strong></p>
            <p><strong>Role:</strong> CEO & Backend Developer</p>
        ...
        <div class="footer">
            <img src="https://media.giphy.com/media/l4Ep6E4tShl8KAyu4/giphy.gif" alt="Thank You">
